...
data.checker<-function(posts_x, forum_x, enrol_x, pc_x, users_x, of.interest,
  ...
  # Covariate Of Interest Response
  users_x$leftright<-ifelse(of.interest=="wvsurvey_1",
  ...
  posts_x$course.post<-1*(posts_x$author_username%in%course.team.names)
